...
#include "qbuWidgets/qbuFilterTableHeader.h"
#include "qbuWidgets/qbuTableFilterLineEdit.h"

#include <QApplication>
#include <QTableView>
#include <QScrollBar>

qbuFilterTableHeader::qbuFilterTableHeader(QTableView* parent) :
...
void qbuFilterTableHeader::generateFilters(int number, bool showFirst)
{
    ...
    {
        qbuTableFilterLineEdit* l = new qbuTableFilterLineEdit(this, &filterWidgets, i);
...
QSize qbuFilterTableHeader::sizeHint() const
{
...
void qbuFilterTableHeader::updateGeometries()
{
...
void qbuFilterTableHeader::adjustPositions()
{
...
void qbuFilterTableHeader::inputChanged(const QString& new_value)
{
...
void qbuFilterTableHeader::clearFilters()
{
    foreach (qbuTableFilterLineEdit* qbuTableFilterLineEdit, filterWidgets)
        qbuTableFilterLineEdit->clear();
}

void qbuFilterTableHeader::setFilter(int column, const QString& value)
{
